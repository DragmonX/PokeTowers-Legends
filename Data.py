...
class Pokemon():
	def __init__(self, name, moveleft, movedown, moveup, moveright, hp, speed, attack, defence):
		...
		self.cost = 2*((hp+attack//4+defence+speed//2)//5*5)
...
pokemon = [	 Pokemon("Chespin", [2, 20], [37, 55], [1, 19], [38, 56], 55, 40, 60, 65)
		   , Pokemon("Quilladin", [4, 22], [39, 57], [3, 21], [40, 58], 60, 55, 80, 95)
		   , Pokemon("Chesnaught", [6, 24], [41, 59], [5, 23], [42, 60], 100, 65, 105, 120)
		   , Pokemon("Fennekin", [8, 26], [43, 61], [7, 25], [44, 62], 40, 60, 60, 60)
		   , Pokemon("Braixen", [10, 28], [45, 63], [9, 27], [46, 64], 60, 70, 90, 70)
		   , Pokemon("Delphox", [12, 30], [47, 65], [11, 29], [48, 66], 75, 105, 115, 100)
		   , Pokemon("Froakie", [14, 32], [49, 67], [13, 31], [50, 68], 40, 70, 60, 45)
		   , Pokemon("Frogadier", [16, 34], [51, 69], [15, 33], [52, 70], 55, 95, 85, 55)
		   , Pokemon("Greninja", [18, 36], [53, 71], [17, 35], [54, 72], 70, 130, 155, 70)
		   , Pokemon("Bunnelby", [74, 92], [109, 127], [73, 91], [110, 128], 40, 55, 35, 40)
		   , Pokemon("Diggersby", [76, 94], [111, 129], [75, 93], [112, 130], 85, 80, 55, 75)
		   , Pokemon("Fletchling", [78, 96], [113, 131], [77, 95], [114, 132], 45, 50, 50, 45)
		   , Pokemon("Fletchinder", [80, 98], [115, 133], [79, 97], [116, 134], 60, 85, 75, 55)
		   , Pokemon("Talonflame", [82, 100], [117, 135], [81, 99], [118, 136], 80, 125, 80, 70)
		]
